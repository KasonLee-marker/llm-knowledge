...
| **Gemini 3.5 Flash** | 2026-05 (Google I/O) | 1M | ✅（图/视/音）| ~¥2.4-3.6 | ~¥14.6 | ~$0.33-$0.50 | ~$2.00 | Agent 优化，超越 3.1 Pro 🚀 |

> 💡 **上下文分级定价**：Gemini 3/3.5 系列采用上下文分级定价，≤200K 为标准价格，>200K 输入价格翻倍
...
### 3.2 Gemini 3.5 Flash：2026 Google I/O Agent 旗舰（2026-05-19）

Google I/O 2026 发布的 Gemini 3.5 Flash 是专为 Agent 场景优化的新一代模型，在多项基准上超越了此前旗舰 Gemini 3.1 Pro。

**核心突破**：
- **Agent 优先设计**：在编程、Agentic 任务、多模态理解上全面超越 Gemini 3.1 Pro
- **4x 更快生成**：token 生成速度是其他前沿模型的 4 倍
- **极致性价比**：价格约为 Gemini 3.1 Pro 的 1/3 到 1/2
- 原生多模态（图像/视频/音频）
- 1M token 上下文窗口

**关键基准对比**（Gemini 3.5 Flash vs Gemini 3.1 Pro）：

| 维度 | Gemini 3.5 Flash | Gemini 3.1 Pro |
|------|-----------------|----------------|
| 编程（SWE-Bench） | ✅ 超越 | 基准 |
| Agentic 任务 | ✅ 超越 | 基准 |
| 多模态理解 | ✅ 超越 | 基准 |
| 生成速度 | **4x 更快** | 基准 |
| 价格（输入/输出） | ~$0.33-$0.50 / ~$2.00 | $2.00-$4.00 / $12.00-$18.00 |

**定位**：高速度、低成本的 Agentic 模型，适合需要频繁模型调用的复杂 Agent 工作流。

### 3.3 Gemini 3 Flash / Flash-Lite：极致性价比
...
### 5.5 Gemini App 更新（Google I/O 2026）

#### 5.5.1 Neural Expressive UI 全新交互界面

Gemini App 全面焕新为 "Neural Expressive" 设计语言：
- 动态自适应布局，根据任务类型智能调整界面
- 深度整合多模态交互（语音、视频、屏幕共享）
- 更直观的 Agent 状态可视化

#### 5.5.2 24/7 Spark Agent
...
| Agentic 工作流 | **Gemini 3.5 Flash** | Agent 优化，4x 速度，低成本 🆕 |
| 编程任务 | Gemini 3.1 Pro / 3.5 Flash | 编程能力最强 |
...
| **Gemini 3.5 Flash 🆕** | **~$0.33-$0.50** | **~$2.00** | **1M** | **✅** | **★★★★★** |
