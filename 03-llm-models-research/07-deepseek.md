...
|------|---------|--------|---------|------------|------------|--------|---------|--------|
| DeepSeek-R1-Zero | 2025-01 | 671B | 纯 RL | ¥4 | ¥16 | 71.0% | 95.9% | MIT |
| DeepSeek-R1 | 2025-01 | 671B | RL + SFT | ¥4 | ¥16 | **79.8%** | **97.3%** | MIT ⭐ |
...
|------|----------------|--------------|------|
| DeepSeek-V3（含 0324）| **¥2/百万** | ¥0.1/百万 | **¥8/百万** |
| DeepSeek-R1 | **¥4/百万** | ¥1/百万 | **¥16/百万** |

> 💡 **价格竞争力**：与 GPT-4o（¥18.3/¥73 百万）相比，DeepSeek-V3 仅约 1/10 成本。
...
## 3.5 DeepSeek-V3-0324（2025年3月重要更新）

DeepSeek 于 2025 年 3 月 24 日悄悄推送了 V3 的重大升级版，无需额外费用：

| 项目 | DeepSeek-V3（原版） | DeepSeek-V3-0324 |
|------|------------------|-----------------|
| AIME 2025 | 39.2% | **59.4%** |
| SWE-Bench | — | 37.6% |
| LiveCodeBench | 40.6% | 49.2% |
