...
### 1. 01-agent-basics - Agent 基础 ✅

| 知识点 | 文件 | 状态 | 备注 |
|--------|------|------|------|
| 什么是 Agent | 01-what-is-agent.md | ✅ | 完整 |
| Agent 架构 | 02-agent-architecture.md | ✅ | 完整 |
| LLM 驱动的 Agent | 03-llm-agents.md | ✅ | 完整 |
...
| 知识点 | 文件 | 状态 | 备注 |
|--------|------|------|------|
| Tokens 与 Context | 01-tokens-and-context.md | ✅ | 完整 |
| Prompt 工程 | 02-prompt-engineering.md | ✅ | 完整 |
| Function Calling | 03-function-calling.md | ✅ | 完整 |
| 推理技术 | 04-reasoning-techniques.md | ✅ | 完整 |
...
| 知识点 | 文件 | 状态 | 备注 |
|--------|------|------|------|
| LangChain 概述 | 01-langchain-overview.md | ✅ | 完整 |
| LangChain in Java | 02-langchain-in-java.md | ✅ | 完整 |
| Semantic Kernel | 03-semantic-kernel.md | ✅ | 完整 |
...
| 知识点 | 文件 | 状态 | 备注 |
|--------|------|------|------|
| OpenAI API | 01-openai-api.md | ✅ | 完整 |
| Azure OpenAI | 02-azure-openai.md | ✅ | 完整 |
| Anthropic API | 03-anthropic-claude.md | ✅ | 完整 |
| Google Gemini API | 04-google-gemini.md | ✅ | 完整 |
| 本地 LLM | 05-local-llms.md | ✅ | 完整 |
| 集成模式 | 06-api-integration-patterns.md | ✅ | 完整 |

### 6. 06-rag-knowledge-retrieval - RAG 检索 ✅

| 知识点 | 文件 | 状态 | 备注 |
|--------|------|------|------|
| RAG 基础 | 01-rag-basics.md | ✅ | 完整 |
| Embedding 模型 | 02-embedding-models.md | ✅ | 完整 |
| 向量数据库 | 03-vector-databases.md | ✅ | 完整 |
| 检索策略 | 04-retrieval-strategies.md | ✅ | 完整 |
| RAG 架构 | 05-rag-architectures.md | ✅ | 完整 |
| 文档处理 | 06-document-processing.md | ✅ | 完整 |
| RAG 评估 | 07-rag-evaluation.md | ✅ | 完整 |
| Java 实战 | 08-java-rag-practice.md | ✅ | 完整 |

### 7. 07-multi-agent-systems - 多智能体系统 ✅

| 知识点 | 文件 | 状态 | 备注 |
|--------|------|------|------|
| 多智能体基础 | 01-multi-agent-basics.md | ✅ | 完整 |
| 通信机制 | 02-agent-communication.md | ✅ | 完整 |
| 协作模式 | 03-coordination-patterns.md | ✅ | 完整 |
| 框架对比 | 04-frameworks-comparison.md | ✅ | 完整 |
| 任务分解 | 05-task-decomposition.md | ✅ | 完整 |
| 冲突解决 | 06-conflict-resolution.md | ✅ | 完整 |
| Java 实战 | 07-java-multi-agent-practice.md | ✅ | 完整 |

### 8. 08-model-safety-alignment - 安全与对齐 ✅

| 知识点 | 文件 | 状态 | 备注 |
|--------|------|------|------|
| 安全概述 | 01-safety-overview.md | ✅ | 完整 |
| Prompt 注入 | 02-prompt-injection.md | ✅ | 完整 |
| 输出审查 | 03-output-safety.md | ✅ | 完整 |
| 隐私保护 | 04-privacy-protection.md | ✅ | 完整 |
| 越狱防御 | 05-jailbreak-defense.md | ✅ | 完整 |
| 幻觉缓解 | 06-hallucination-mitigation.md | ✅ | 完整 |
| Java 实战 | 07-java-safety-practice.md | ✅ | 完整 |

### 9. 09-performance-monitoring - 性能优化 ✅

| 知识点 | 文件 | 状态 | 备注 |
|--------|------|------|------|
| 性能指标 | 01-performance-metrics.md | ✅ | 完整 |
| 缓存策略 | 02-caching-strategies.md | ✅ | 完整 |
| 流式优化 | 03-streaming-optimization.md | ✅ | 完整 |
...
| 知识点 | 文件 | 状态 | 备注 |
|--------|------|------|------|
| 代码生成助手 | 01-code-assistant.md | ✅ | 完整 |
| 智能客服 | 02-customer-service-bot.md | ✅ | 完整 |
