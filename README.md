...
- [06 - RAG / 知识检索](#06---rag--知识检索)
- [07 - 多智能体系统](#07---多智能体系统)
- [08 - 模型安全与对齐](#08---模型安全与对齐)
- [09 - 性能优化与监控](#09---性能优化与监控)
- [10 - 实战案例集](#10---实战案例集)
...
```
llm-knowledge/
├── README.md                    # 本文件 - 知识库总览入口
├── AGENTS.md                    # 智能体工作导航（项目治理）
├── TODO-modules.md              # 模块任务清单
│
├── 01-agent-basics.md           # ┐
├── 02-llm-fundamentals.md       # │ 各模块顶层入口文件
├── 03-llm-models-research.md    # │ 包含模块简介与子主题链接
├── ...                          # ┘
│
├── 01-agent-basics/             # ┐
├── 02-llm-fundamentals/         # │ 各模块子文档目录
├── 03-llm-models-research/      # │ 包含该模块的所有细分文档
├── ...                          # ┘
│
├── docs/                        # 知识库治理文档
│   ├── architecture.md          # 知识体系架构与模块依赖图
│   ├── coverage-matrix.md       # 知识点覆盖矩阵与完成度追踪
│   ├── quality-standards.md     # 文档写作质量标准
...
| 文档 | 用途 |
|------|------|
| [docs/architecture.md](./docs/architecture.md) | 知识体系架构、模块依赖关系与学习路径 |
| [docs/coverage-matrix.md](./docs/coverage-matrix.md) | 各模块完成度、覆盖缺口与待办任务 |
| [docs/quality-standards.md](./docs/quality-standards.md) | 文档写作规范与质量标准 |
...
详细路径说明见 [docs/architecture.md](./docs/architecture.md)。
...
详细覆盖矩阵与待更新项见 [docs/coverage-matrix.md](./docs/coverage-matrix.md)。
...
完整变更记录见 [docs/coverage-matrix.md](./docs/coverage-matrix.md)。
